...
# ... From Option B of the exercise: build prototype vector for each category, using the categorisation dictionary category_to_words
#plot_with_tsne(vectors_to_plot, tokens_to_plot, color_coding=token_colours, outfile_name="vis_cats_words_prototypes_coloured")

### *** New in Option C: clustering word embeddings into categories ***
import sklearn # Machine Learning library
from sklearn.cluster import KMeans # KMeans function to do, well, k-means clustering :)

num_clusters = 11
all_words = list(taxonomy.keys())
...
# compute purity:
#purity_score = get_purity(clusters_of_words, reference_clusters)
