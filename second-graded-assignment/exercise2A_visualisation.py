...
def word_vec_list(sem_model, relevant_words):
    ...
    # (1a) iterate over the list 
        # (1b) retrieve the embedding (vector / numpy array) from the semantic model (hint: see the function retrieve_vector)
            # (1c) if an embedding could be retrieved (i.e., it "is in sem_model"), 
...
# found in the semantic model (and for which the vector has been retrieved). 
